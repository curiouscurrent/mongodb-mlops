...
class Proj1Data:
    """
    The records are stored in database collection in MongoDB.
    ...
    def import_collection_as_dataframe(self, collection_name: str, database_name: Optional[str] = None) -> pd.DataFrame:
        """
        The records which are in the form of dictionary imported as a pandas Dataframe.
        Imports an entire MongoDB collection as a pandas DataFrame.

        Parameters:
        ----------
        collection_name : str
            The name of the MongoDB collection to import.
