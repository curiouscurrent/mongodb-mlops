...
class EvaluateModelResponse:
    trained_model_f1_score: float # newly trained model f1 score
    best_model_f1_score: float # production model f1 score, if there is no model in production it will be None
...
class ModelEvaluation:
    ...
    def __init__(self, model_eval_config: ModelEvaluationConfig, data_ingestion_artifact: DataIngestionArtifact,
        ...
        """
        We need to evaluate on the test data generated from
        data ingestion artifact.
        """
        try:
            self.model_eval_config = model_eval_config
            self.data_ingestion_artifact = data_ingestion_artifact
            # we need to evaluate on the test data generated from data ingestion artifact.
